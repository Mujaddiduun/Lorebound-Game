...
export const gameData = {
  zones: [
    {
      id: 'forest_echoes',
      name: 'Forest of Echoes',
      description: 'Ancient whispers guide travelers through mystical woodlands.',
      isUnlocked: true,
      x: 200,
      y: 300,
      color: '#22c55e'
    },
    {
      id: 'crystal_caverns',
      name: 'Crystal Caverns',
      description: 'Resonant crystals sing with otherworldly melodies.',
      isUnlocked: false,
      x: 400,
      y: 200,
      color: '#8b5cf6'
    },
    {
      id: 'shadow_peaks',
      name: 'Shadow Peaks',
      description: 'Towering mountains shrouded in eternal mist.',
      isUnlocked: false,
      x: 600,
      y: 150,
      color: '#6b7280'
    },
    {
      id: 'ethereal_gardens',
      name: 'Ethereal Gardens',
      description: 'Floating gardens where reality bends and flows.',
      isUnlocked: false,
      x: 300,
      y: 400,
      color: '#f59e0b'
  ...
  quests: [
    {
      id: 'whispers_in_woods',
      title: 'Whispers in the Woods',
      description: 'Strange voices echo through the Forest of Echoes. Investigate their source.',
      objectives: [
        'Find the source of mysterious whispers',
        'Commune with the forest spirit',
        'Make a choice about the spirit\'s request'
      ],
      rewards: [
        { type: 'xp', value: 50, description: '+50 Experience Points' },
        { type: 'trait', value: 'explorer', description: 'Explorer Trait' }
      ],
      zoneId: 'forest_echoes',
      storyChoices: [
        {
          id: 'peaceful_approach',
          text: 'Approach peacefully',
          description: 'Offer friendship to the forest spirit',
          consequences: {
            xp: 25,
            traits: ['peaceful_soul']
          }
        },
        {
          ...
          description: 'Keep your guard up while listening',
          consequences: {
            xp: 15,
            traits: ['scholar']
          }
    ...
    },
    {
      id: 'crystal_resonance',
      title: 'Songs of the Crystal',
      description: 'The crystals sing with ancient power. Learn their harmonies.',
      objectives: [
        'Find the resonance frequency',
        'Achieve crystal harmony',
        'Unlock the cavern\'s secret'
      ],
      rewards: [
        { type: 'xp', value: 100, description: '+100 Experience Points' },
        { type: 'trait', value: 'crystal_singer', description: 'Crystal Singer Trait' },
        { type: 'zone_unlock', value: 'shadow_peaks', description: 'Unlock Shadow Peaks' }
      ],
      zoneId: 'crystal_caverns',
      requiredTraits: ['explorer'],
      storyChoices: [
        {
          id: 'gentle_harmony',
          text: 'Sing gently with the crystals',
          description: 'Match the crystal\'s gentle vibrations',
          consequences: {
            xp: 50,
            traits: ['harmony_keeper']
          }
        },
        {
          id: 'forceful_resonance',
          text: 'Force a stronger resonance',
          description: 'Push the crystals to reveal more power',
          consequences: {
            xp: 30,
            traits: ['power_seeker']
          }
    ...
    {
      id: 'mountain_ascent',
      title: 'Peak of Shadows',
      description: 'Climb the treacherous Shadow Peaks to reach the summit.',
      objectives: [
        'Navigate the shadow maze',
        'Overcome the guardian spirit',
        'Reach the mountain peak'
      ],
      rewards: [
        { type: 'xp', value: 150, description: '+150 Experience Points' },
        { type: 'trait', value: 'peak_conqueror', description: 'Peak Conqueror Trait' },
        { type: 'zone_unlock', value: 'ethereal_gardens', description: 'Unlock Ethereal Gardens' }
      ],
      zoneId: 'shadow_peaks',
      requiredLevel: 3,
      requiredTraits: ['crystal_singer']
    },
    {
      id: 'garden_mysteries',
      title: 'Floating Revelations',
      description: 'Explore the impossible gardens that defy gravity itself.',
      objectives: [
        'Understand the garden\'s magic',
        'Collect ethereal essence',
        'Discover the ancient secret'
      ],
      rewards: [
        { type: 'xp', value: 200, description: '+200 Experience Points' },
        { type: 'trait', value: 'reality_walker', description: 'Reality Walker Trait' },
        { type: 'nft', value: 'garden_lore', description: 'Garden Lore NFT' }
      ],
      zoneId: 'ethereal_gardens',
      requiredLevel: 5,
      requiredTraits: ['peak_conqueror']
    }
  ] as Quest[],
  ...
  traits: [
    {
      id: 'explorer',
      name: 'Explorer',
      description: 'A curious soul drawn to discover hidden places.',
      rarity: 'common'
    },
    {
      id: 'scholar',
      name: 'Scholar',
      description: 'Seeks knowledge and understanding above all.',
      rarity: 'common'
    },
    {
      id: 'peaceful_soul',
      name: 'Peaceful Soul',
      description: 'Chooses harmony over conflict.',
      rarity: 'rare'
    },
    {
      id: 'crystal_singer',
      name: 'Crystal Singer',
      description: 'Can commune with ancient crystal magic.',
      rarity: 'rare'
    },
    {
      id: 'harmony_keeper',
      name: 'Harmony Keeper',
      description: 'Maintains balance between opposing forces.',
      rarity: 'epic'
    },
    {
      id: 'power_seeker',
      name: 'Power Seeker',
      description: 'Driven to unlock greater magical abilities.',
      rarity: 'epic'
    },
    {
      id: 'peak_conqueror',
      name: 'Peak Conqueror',
      description: 'Has conquered the highest mountain peaks.',
      rarity: 'epic'
    },
    {
      id: 'reality_walker',
      name: 'Reality Walker',
      description: 'Can traverse between different planes of existence.',
      rarity: 'legendary'
    }
  ] as PlayerTrait[]
};
